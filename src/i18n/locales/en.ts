export default {
  ...
  "home.headline2":"Notion AI is a plugin developed based on Notion's official AI.<wbr /> By subscribing to this plugin, you can enjoy the same Notion AI experience as the official one for less than 1/4 of the original price. The plugin supports multiple systems, including Mac, Windows, and Android.",
  "home.menu":"Purchase",
